...
"Python path handling to use $ which python in bash, im not sure what the
"wincuck equivilent is 
...
"Terminal
 function TermToggle()
 	 let g:terminal_color_4 = '#2c4034'
	 sp 
	 term
	 resize 10 
	 let g:terminal_color_0 = '#2c4034'
...
"Autocorrect
let g:is_correct_enabled = 0 
function ToggleCorrect()
	if g:is_correct_enabled == 0
		EnableAutocorrect
		echo "Correct Activated"
		let g:is_correct_enabled = 1
	else 
		DisableAutocorrect
		echo "Correct Deactivated"
		let g:is_correct_enabled = 0 
	endif 
endfunction

nmap <leader>tl :call ToggleCorrect()<CR>  
